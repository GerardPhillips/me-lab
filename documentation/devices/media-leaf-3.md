...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_MEDIA-SPINE-1_Ethernet17/1 | routed | - | 192.168.102.129/31 | default | 9000 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_MEDIA-SPINE-1_Ethernet18/1 | routed | - | 192.168.102.133/31 | default | 9000 | False | - | - |
| Ethernet51/1 | P2P_LINK_TO_MEDIA-SPINE-2_Ethernet17/1 | routed | - | 192.168.102.131/31 | default | 9000 | False | - | - |
| Ethernet52/1 | P2P_LINK_TO_MEDIA-SPINE-2_Ethernet18/1 | routed | - | 192.168.102.135/31 | default | 9000 | False | - | - |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- |
| 192.168.102.128 | 65411 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 192.168.102.130 | 65412 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 192.168.102.132 | 65411 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 192.168.102.134 | 65412 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
