...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management_interface | oob | MGMT | 10.90.227.29/24 | 10.90.227.1 |
...
| -------- | --------- | ---------- | ---------- | --- | ------ | ---- | --------------- |
| 00:1C:73:1e:00:09 | - | 30 | 9 | - | 127 | boundary | - |

#### PTP Device Configuration

```eos
!
ptp clock-identity 00:1C:73:1e:00:09
ptp domain 127
ptp mode boundary
ptp priority1 30
ptp priority2 9
...
```eos
!
hardware speed-group 7 serdes 25g
hardware speed-group 8 serdes 25g
```
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_media-spine-1_Ethernet17/1 | - | 192.168.102.129/31 | default | 9214 | False | - | - |
| Ethernet50/1 | P2P_media-spine-1_Ethernet18/1 | - | 192.168.102.133/31 | default | 9214 | False | - | - |
| Ethernet51/1 | P2P_media-spine-2_Ethernet17/1 | - | 192.168.102.131/31 | default | 9214 | False | - | - |
| Ethernet52/1 | P2P_media-spine-2_Ethernet18/1 | - | 192.168.102.135/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 172.24.0.29/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 192.168.102.128 | 65411 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 192.168.102.130 | 65412 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 192.168.102.132 | 65411 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 192.168.102.134 | 65412 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
...
router bgp 65429
   ...
   neighbor 192.168.102.128 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.102.128 remote-as 65411
   neighbor 192.168.102.128 description media-spine-1_Ethernet17/1
   neighbor 192.168.102.130 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.102.130 remote-as 65412
   neighbor 192.168.102.130 description media-spine-2_Ethernet17/1
   neighbor 192.168.102.132 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.102.132 remote-as 65411
   neighbor 192.168.102.132 description media-spine-1_Ethernet18/1
   neighbor 192.168.102.134 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.102.134 remote-as 65412
   neighbor 192.168.102.134 description media-spine-2_Ethernet18/1
